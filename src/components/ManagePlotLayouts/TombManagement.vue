<template>
    <v-card class="tomb-management">
      <v-container fluid>
        <HeaderSection :selectedCollectionTitle="selectedCollectionTitle" v-model="search" />
        <CollectionNavigation :collections="collections" :selectedCollection="selectedCollection" @selectCollection="selectCollection" @openMap="openMap" />
        <DataTable title="Available Items" :items="availableItems" :search="search" :loading="isLoading" @editItem="editItem" /> 
        <EditDialog v-model="editDialog" :editedItem="editedItem" :formTitle="formTitle" @saveItem="saveItem" @closeEdit="closeEdit" />
        <v-btn @click="openMap">Open Map</v-btn>
        <MapDialog v-model="dialog" :selectedCollectionTitle="selectedCollectionTitle" :tombs="tombs" />
        <BoneVaultDialog v-model="boneVaultDialog" :availableBoneVaultSlots="availableBoneVaultSlots" @confirmMoveToVault="confirmMoveToVault" />
        <DetailsDialog v-model="detailsDialog" :selectedTomb="selectedTomb" @close="detailsDialog = false" />
      </v-container>
    </v-card>
  </template>
...
const tombs = ref([]);
import HeaderSection from '@/components/ManagePlotLayouts/HeaderSection.vue';
  import CollectionNavigation from '@/components/ManagePlotLayouts/CollectionNavigation.vue';
  import DataTable from '@/components/ManagePlotLayouts/DataTable.vue';
  import EditDialog from '@/components/ManagePlotLayouts/EditDialog.vue';
  import MapDialog from '@/components/ManagePlotLayouts/MapDialog.vue';
  import BoneVaultDialog from '@/components/ManagePlotLayouts/BoneVaultDialog.vue';
  import DetailsDialog from '@/components/ManagePlotLayouts/DetailsDialog.vue';
const collections = [
